...
-- given i & j, return i - j.
iminus : Int → Int → Int
iminus (int a b) (int c d)= int(plus a d) (plus b c) -- same system as earlier code 

-- given i & j, return i * j.
itimes : Int → Int → Int
itimes (int a b) (int c d) = int (plus (times a c) (times b d)) (plus (times a d) (times b c))

-- with this last asnwer, I used the help of a couple online forums, mostle dealign with mathematical algebra
-- https://plfa.github.io this was a difficualt question